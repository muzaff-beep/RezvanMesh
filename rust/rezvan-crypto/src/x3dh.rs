...
pub struct SessionState {
    ...
    pub sending_ratchet_private: [u8; 32],
    pub sending_ratchet_public: [u8; 32],
    pub receiving_ratchet_public: Option<[u8; 32]>,
    pub sending_message_number: u32,
    pub receiving_message_number: u32,
    pub previous_sending_chain_length: u32,
    pub skipped_message_keys: std::collections::HashMap<(u32, [u8; 32]), [u8; 32]>,
}
...
pub fn receive_x3dh(
    ...
    let their_id_x25519 = convert_ed_pub_to_x25519(their_identity);
    let (_signed_prekey_private, _signed_prekey_public) = get_signed_prekey_for_handshake()?;
